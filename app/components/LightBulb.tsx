...
const white = "#FFFFFF";
const taupeGray = "#868491";
const frenchGray = "#B4B6BC";
const englishViolet = "#5C546A";

const jonquil = "#FFCD00";

export type LightBulbProps = {
  bulbColor?: string;
};

export default function LightBulb({ bulbColor = jonquil }: LightBulbProps) {
  const glareColor = lighten(bulbColor, 0.4);
